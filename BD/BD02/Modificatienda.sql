...
ALTER TABLE STOCK ADD(
	...
	Beneficio NUMBER(1) CONSTRAINT st_ben_ch CHECK(Beneficio>0 && Beneficio<=5));
...
ALTER TABLE TIENDA ADD CONSTRAINT tie_pos_un UNIQUE;
...
CREATE USER INVITADO IDENTIFIED BY MyPassword;
...
REVOKE ALL PRIVILEGES FROM INVITADO;
